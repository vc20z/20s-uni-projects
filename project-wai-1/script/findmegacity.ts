    ...
    if(status!==null) {
        ...
        function success(position: GeolocationPosition) {
            if(position !== null) {
                ...
                status.textContent = `Najbliższym Megamiastem dla ciebie jest ${megacity[cityNum] ?? 'NIEDOSTĘPNE'}`
            }
        }
...
const button = document.querySelector("#megacityfinder") as HTMLElement;
if (button!==null) {
